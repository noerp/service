 ...
 * jsse.properties
 * noerp-base.jar
 * noerp-service-rmi.jar (copied and renamed from "vendor/noerp/service/build/lib/noerp-service-rmi.raj" from an NoERP build)
 *
 * The following third-party libraries (can be found in NoERP) also need to be on the client's classpath:
 * commons-collections.jar
 * javolution.jar
 * jdbm.jar
 * log4j.jar
 *
 * Copy the truststore file vendor/noerp/base/config/rmi-truststore.jks to the client
 *
 * Run the client specifying the path to the client truststore: -Djavax.net.ssl.trustStore=rmi-truststore.jks
 *
 */

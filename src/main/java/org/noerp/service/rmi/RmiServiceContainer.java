...
public class RmiServiceContainer implements Container {
    ...
    public boolean start() throws ContainerException {
        ...
        if (ssf != null && ssf instanceof org.noerp.service.rmi.socket.ssl.SSLServerSocketFactory) {
            ((org.noerp.service.rmi.socket.ssl.SSLServerSocketFactory) ssf).setNeedClientAuth(clientAuth);
            ((org.noerp.service.rmi.socket.ssl.SSLServerSocketFactory) ssf).setKeyStoreAlias(ksAlias);
            if (keystore != null) {
                ((org.noerp.service.rmi.socket.ssl.SSLServerSocketFactory) ssf).setKeyStore(keystore, ksType, ksPass);
            }
        }
